...
angular.module("leaflet-directive").factory('leafletMapDefaults', ["$q", "leafletHelpers", function ($q, leafletHelpers) {
    function _getDefaults() {
        return {
            ...
            crs: L.CRS.EPSG3857,
            tileLayer: '//api.tiles.mapbox.com/v4/hunterowens2.m0lnepeh/{z}/{x}/{y}.png?access_token=pk.eyJ1IjoiaHVudGVyb3dlbnMyIiwiYSI6ImI5dzd0YWMifQ.fFpJUocWQigRBbrLOqU4oQ',
            tileLayerOptions: {
                attribution: '&copy; <a href="http://www.mapbox.com/copyright">Mapbox</a> contributors'
            },
            path: {
                weight: 10,
                opacity: 1,
